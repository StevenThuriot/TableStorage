...
/// <summary>
/// Tests for FluentPartitionTableEntity extension methods
/// Covers FindAsync, WhereFirstType, WhereSecondType, and type-specific query operations
/// </summary>
public class FluentPartitionQueryTests(AzuriteFixture azuriteFixture) : AzuriteTestBase(azuriteFixture)
{
    ...
    [Fact]
    public async Task FindAsync_WithMultipleRowKeys_ShouldReturnAllMatchingEntities()
    {
        // Arrange
    ...
    [Fact]
    public async Task FindAsync_WithMultipleRowKeys_AndSomeNonExistent_ShouldReturnOnlyExisting()
    {
        // Arrange
        FluentTestModelA modelA = new()
        {
    ...
    public async Task WhereFirstType_WithAsyncEnumeration_ShouldWork()
    {
        ...
        await foreach (var item in Context.FluentPartitionModels.WhereFirstType())
        {
            results.Add(item);
        }
    ...
    public async Task WhereSecondType_WithAsyncEnumeration_ShouldWork()
    {
        ...
        await foreach (var item in Context.FluentPartitionModels.WhereSecondType())
        {
            results.Add(item);
        }
